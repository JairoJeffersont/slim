...
class __TwigTemplate_cea226217182698ea8e88b615aa1e170 extends Template
{
...
\t\t\t\t";
        ...
        if ((($context["status"] ?? null) == "info")) {
            // line 19
            yield "\t\t\t\t\t<div class=\"alert alert-info rounded-pill py-2 px-4 border-0 text-center small fw-semibold mb-2\" data-time=\"3\">
\t\t\t\t\t\t";
            // line 20
...
\t\t\t\t\t\t";
        // line 37
        yield "\t\t\t\t\t\t<input type=\"email\" name=\"email\" class=\"form-control rounded-pill py-2 px-4\" value=\"";
        yield (string) (((CoreExtension::getAttribute($this->env, $this->source, ($context["dados"] ?? null), "email", [], "any", true, true, false, 37) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["dados"] ?? null), "email", [], "any", false, false, false, 37)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["dados"] ?? null), "email", [], "any", false, false, false, 37), "html", null, true)) : ("jairojeffersont@gmail.com"));
        yield "\" placeholder=\"E-mail\" required>
\t\t\t\t\t</div>

\t\t\t\t\t<div class=\"mb-4\">
\t\t\t\t\t\t<input type=\"password\" name=\"senha\" class=\"form-control rounded-pill py-2 px-4\" value=\"intell01\" placeholder=\"Senha\" required>
\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  118 => 37,  112 => 32,  106 => 29,  100 => 26,  97 => 25,  95 => 24,  92 => 23,  86 => 20,  83 => 19,  81 => 18,  76 => 16,  70 => 13,  59 => 4,  52 => 3,  41 => 1,);
    }
...
\t\t\t\t<p class=\"card-text text-center text-white\">{{ app_slogan }}</p>

\t\t\t\t{% if status == \x27info\x27 %}
\t\t\t\t\t<div class=\"alert alert-info rounded-pill py-2 px-4 border-0 text-center small fw-semibold mb-2\" data-time=\"3\">
\t\t\t\t\t\t{{ message }}
\t\t\t\t\t</div>
\t\t\t\t{% endif %}
...
\t\t\t\t\t<div
\t\t\t\t\t\tclass=\"mb-2\">
\t\t\t\t\t\t{# Adicionado a tag \x27value\x27 dinâmica para não perder o e-mail digitado em caso de erro de senha #}
\t\t\t\t\t\t<input type=\"email\" name=\"email\" class=\"form-control rounded-pill py-2 px-4\" value=\"{{ dados.email ?? \x27jairojeffersont@gmail.com\x27 }}\" placeholder=\"E-mail\" required>
\t\t\t\t\t</div>
...
\t</div>
{% endblock %}
", "pages/login/form_login.twig", "/Users/jairo/Sites/slim/src/Views/pages/login/form_login.twig");
    }
}
